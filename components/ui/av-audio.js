export default class AVAudio extends HTMLElement {
  connectedCallback() {
    ...
    this.innerHTML = `
      ...
      <style>
        ...
        av-audio .av-audio-button:hover {
          background: var(--poster);
          border-color: var(--poster-dark);
        }

        av-audio .av-audio-content {
          display: grid;
          gap: .25rem;
          min-width: 0;
          flex-grow: 1;
        ...
        av-audio .av-audio-title {
          font: var(--f-base) var(--f-metadata);
        }

        av-audio .av-audio-status {
      ...
      <article class="av-audio">

        <button class="av-audio-button" type="button" aria-label="Reproducir audio">
        ...
        <div class="av-audio-content">
          <div class="av-audio-title">
            ${titulo}
          </div>

          <div class="av-audio-status">
            detenido
          </div>
